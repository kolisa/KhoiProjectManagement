...
namespace KhoiProjectManagement.Application
{
    ...
    {
        private readonly IRepository<LibraryFile> _fileRepo;
        private readonly IRepository<LibraryFileVersion> _versionRepo;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IAuthorizationService _authorizationService;
        private readonly IConfiguration _configuration;

        public LibraryService(
            IRepository<LibraryFile> fileRepo,
            IRepository<LibraryFileVersion> versionRepo,
        ...
        public async Task<List<LibraryFileDto>> GetFilesAsync(int spaceId, ClaimsPrincipal caller)
        {
            ...
            var files = await _fileRepo.Query()
                .Include(f => f.Creator)
        ...
        public async Task<bool> UploadNewVersionAsync(int id, IFormFile file, string? comment, ClaimsPrincipal caller)
        {
            ...
            _versionRepo.Add(new LibraryFileVersion
            {
