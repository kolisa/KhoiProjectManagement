...
namespace KhoiProjectManagementApi.Services
{
    public class InvoiceService : IInvoiceService
    {
        ...
        public InvoiceService(ProjectManagementContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        public async Task<InvoiceTemplateDto?> SaveAsTemplateAsync(int invoiceId, SaveAsTemplateDto dto, int createdBy)
        {
            ...
            var saved = await _context.InvoiceTemplates.Include(t => t.Creator).FirstAsync(t => t.Id == template.Id);
