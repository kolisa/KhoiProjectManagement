...
namespace KhoiProjectManagementApi.Services
{
    public class HrService : IHrService
    {
        ...
        public HrService(ProjectManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<bool> UpdateTemplateAsync(int id, UpdateOnboardingTemplateDto dto)
        {
            ...
            _context.OnboardingTemplateItems.RemoveRange(template.Items);
        ...
        public async Task<OnboardingChecklistDto> CreateChecklistAsync(CreateOnboardingChecklistDto dto)
        {
            ...
            var saved = await _context.OnboardingChecklists
                .Include(c => c.User)
                .Include(c => c.Template)
                .Include(c => c.Items).ThenInclude(i => i.Completer)
