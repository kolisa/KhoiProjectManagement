...
namespace KhoiProjectManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260904085820_AddSystemOverviewEmailSchedule")]
    partial class AddSystemOverviewEmailSchedule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.LoginAuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.PageVisitLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 23,
                            Action = "view_all",
                            Description = "View and filter every user's reminders",
                            Name = "reminders.view_all",
                            Resource = "reminders"
                        },
                        new
                        {
                            Id = 24,
                            Action = "manage",
                            Description = "Assign a reminder to another user, bulk-act on any reminder",
                        ...
                        new
                        {
                            Id = 27,
                            Action = "broadcast",
                            Description = "Send a broadcast email to users filtered by role",
                        ...
                        new
                        {
                            ...
                            Description = "Configure the weekly system-overview email's on/off switch and schedule",
                            Name = "email.manage_overview",
                            Resource = "email"
                        });
                });
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.SpacePermission", b =>
                {
                    ...
                    b.HasIndex("SpaceId", "RoleId", "UserId", "GroupId")
                        .IsUnique();

                    b.ToTable("SpacePermissions");
                });

            modelBuilder.Entity("KhoiProjectManagement.Domain.SystemOverviewEmailSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SystemOverviewEmailSettings");
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.WikiPage", b =>
                {
                    ...
                    b.Property<string>("CurrentContentMarkdown")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.WikiPageComment", b =>
                {
                    ...
                    b.Property<int?>("AnchorBlockIndex")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.CompanyEvent", b =>
                {
                    ...
                    b.HasOne("KhoiProjectManagement.Domain.User", "Subject")
                        .WithMany()
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.IdeaAttachmentAnnotation", b =>
                {
                    ...
                    b.HasOne("KhoiProjectManagement.Domain.IdeaAttachment", "IdeaAttachment")
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.Invoice", b =>
                {
                    ...
                    b.HasOne("KhoiProjectManagement.Domain.InvoiceTemplate", "CreatedFromTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.Notification", b =>
                {
                    ...
                    b.HasOne("KhoiProjectManagement.Domain.Reminder", "Reminder")
                        .WithMany()
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.Reminder", b =>
                {
                    ...
                    b.HasOne("KhoiProjectManagement.Domain.Reminder", "RecurrenceParent")
                        .WithMany()
                        .HasForeignKey("RecurrenceParentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("KhoiProjectManagement.Domain.Project", "RelatedProject")
                        .WithMany()
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.SpacePermission", b =>
                {
                    b.HasOne("KhoiProjectManagement.Domain.Group", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("KhoiProjectManagement.Domain.SystemOverviewEmailSettings", b =>
                {
                    b.HasOne("KhoiProjectManagement.Domain.User", "UpdatedByUser")
                        .WithMany()
